...
pub struct BanBody {
    pub grund: Option<String>,
    pub dauer_secs: Option<u64>,
    pub ip_bannen: Option<bool>,
}
    ...
    match state
        .ausfuehren(
            Command::ClientBannen {
                client_id: id,
                dauer_secs: body.dauer_secs,
                grund: body.grund,
                ip_bannen: body.ip_bannen.unwrap_or(false),
            },
            session,
        )
        .await
