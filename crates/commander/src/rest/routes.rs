...
pub fn v1_router() -> Router<CommanderState> {
    Router::new()
        ...
        .route("/v1/channels/:id", delete(handlers::channels::delete_channel))
        // Clients
        ...
        // Berechtigungen
        .route("/v1/permissions/:target", get(handlers::permissions::get_permissions))
        .route("/v1/permissions", post(handlers::permissions::set_permission))
        .route("/v1/permissions/:id", delete(handlers::permissions::remove_permission))
        // Dateien
